        ...
        <main class="relative min-h-screen flex flex-col justify-center bg-slate-900 overflow-hidden">
            ...
            <div className="flex items-center justify-center  bg-[#0F172A]">
                ...
                >
                    ...
                    ></span>
                    <span
                        className="relative inline-block border-double border-2  border-current bg-teal-300 px-8 py-4 text-sm font-bold uppercase tracking-widest text-black group-active:text-opacity-75"
                    >
                        Search BNS Sections
                    </span>
                </a>
